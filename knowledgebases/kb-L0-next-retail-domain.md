...
**Positioning:** Middle-market, quality and reliability. Not fast fashion, not premium luxury.

**Differentiator:** Platform business model (Total Platform) — turns competitors into customers by leasing backend infrastructure.

---

## 2. Business Units & Revenue Streams
...
- **Channel-switching:** Common for fit-dependent categories (coats, formalwear, shoes) — research online, buy in-store
- **Repeat purchases:** Everyday basics and repeat purchases are online-only
- **Higher-value purchases:** Extensive online research before store visit
...
|-----------|-------------|--------------|
| Marks & Spencer | Strong brand trust, omnichannel, food+clothing drives footfall | High |
| John Lewis | Premium, strong online, partnership/employee ownership model | Medium |
| ASOS | Pure online, younger demographics, declining GMV | Medium |
| Primark | Value fashion, physical only, no online, massive footfall | Medium |
| Zara / H&M | Fast fashion, stronger trend cycles, global scale | High |
...
## 5. Business Challenges (Current State Problems)

### 5.1 Cross-Channel Customer Recognition
- Customers browsing online are NOT consistently recognised in physical stores
- Preferences, wishlists, and credit account history not accessible to store staff
- **Impact:** Missed personalisation opportunities, fragmented experience
...
### 5.3 Store Associate Enablement
- Staff lack tools to access customer context
- Cannot see: online browsing history, wishlist items, purchase patterns
- Cannot personalise the in-store experience
- **Impact:** Generic in-store service, missed upsell/cross-sell

### 5.4 App Engagement
- App downloaded but engagement weak
- Customers default to mobile website over app
- **Impact:** Lower retention, missed push notification channel

### 5.5 Personalisation Inconsistency
- Website offers personalised recommendations
- In-store and app do NOT consistently leverage browsing/purchase data
- **Impact:** Disjointed experience across channels
...
### 5.8 Data Silos (Root Cause)
- Customer data, inventory data, credit account data, transaction data in separate systems
- This is the underlying infrastructure challenge behind most experience gaps
- **Impact:** Blocks all cross-channel personalisation and recognition
...
| Supply Chain | Inventory, warehousing, delivery logistics, sourcing |

**Key issue:** Systems not always aligned across teams. Total Platform infrastructure is sophisticated for third-party brands but internal customer experience systems have not kept pace.

---

## 7. Customer Behaviour Patterns

### 7.1 Browsing & Discovery
- Browse on mobile during commutes, save items for later
- Follow brand on social media for style inspiration and sale alerts
- Research online extensively for higher-value purchases
...
### 7.3 Post-Purchase
- Return online purchases in-store for faster processing
...
## 8. Key Terminology (Domain Glossary)
...
| Third-party brands | Brands using Total Platform (Reiss, FatFace, Joules) | "partners", "vendors" |

---

## 9. Strategic Context for Loyalty Program
...
- Cross-channel recognition rate
- App engagement (DAU/MAU, session frequency)
- Repeat purchase rate
- Average basket size for loyalty members vs non-members
- Click & Collect conversion (add-on purchases during collection)
- Store associate usage of customer context tools

---

## 10. Retail Domain Concepts

### 10.1 Omnichannel Retail
The practice of providing a seamless customer experience across all channels (online, mobile, physical store). Key principle: the customer is the same person regardless of which channel they use. Data, preferences, and history must follow them.

### 10.2 Loyalty Program Mechanics (Retail)
- **Points accrual:** Earn points per £/$ spent
- **Tier system:** Bronze/Silver/Gold/Platinum based on spend or points
- **Redemption:** Convert points to discounts at checkout
- **Cross-channel:** Points earned in any channel, redeemed in any channel
- **Personalisation trigger:** Loyalty ID enables recognition across channels

### 10.3 Click & Collect Economics
- Lower delivery cost than home delivery
- Drives incremental store footfall
- 30-40% of Click & Collect customers make additional in-store purchases
- Reduces returns (customer sees item before taking home)

### 10.4 Store Associate as Service Channel
- Modern retail treats store associates as personalisation agents
- Requires: customer context tools, real-time inventory, loyalty status visibility
...
## 11. Product Categories & Retail Operations

### 11.1 Product Categories
| Category | Examples | Loyalty Relevance |
|----------|---------|-------------------|
| Clothing | Womenswear, menswear, childrenswear | Core earn category, highest volume |
| Footwear | Shoes, boots, trainers | Fit-dependent — drives store visits |
| Accessories | Bags, jewellery, scarves | Impulse/add-on purchases |
| Home | Furniture, bedding, curtains, kitchenware | Higher basket value, lower frequency |
| Third-party brands | Reiss, FatFace, Joules (via Total Platform) | Cross-brand earn/redeem consideration |

### 11.2 Store Format Evolution
- Stores transitioning from pure retail to **experience/showroom** model
- Larger format stores combining: clothing + home + third-party brands
- Click & Collect as primary footfall driver (not browsing)
- Physical stores stabilising as brand showrooms, not declining

### 11.3 Returns & Refunds
- Online purchases can be returned in-store (cross-channel returns)
- In-store returns processed faster than postal returns
- **Loyalty implication:** Points earned on purchase must be reversed on return (critical business rule)

---

## 12. Geographic & Regulatory Context

### 12.1 Geographic Scope
- **Primary market:** UK and Ireland (450+ stores, full digital presence)
- **International:** ~200 franchise stores across 34 countries (separate operations, likely different systems)
- **Loyalty program scope:** UK-focused initially (domestic stores + online)

### 12.2 UK Regulatory Environment for Retail Loyalty
| Regulation | Relevance to Loyalty Program |
|-----------|------------------------------|
| UK GDPR / DPA 2018 | Customer data collection, consent, right to erasure, data portability |
...
- Loyalty program collects PII (name, email, phone, purchase history)
- Requires: lawful basis for processing (legitimate interest or consent)
- Requires: privacy notice explaining data use
- Requires: data retention policy (how long points/history kept after account closure)
- Cross-channel tracking requires explicit consent under PECR
- Right to erasure: customer can request account deletion (points forfeited)
...
### 13.3 Customer Segments by Payment Method
