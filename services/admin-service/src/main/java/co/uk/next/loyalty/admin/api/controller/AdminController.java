...
import co.uk.next.loyalty.admin.application.command.UpdateCampaignCommand;
import co.uk.next.loyalty.admin.application.command.UpdateRatesConfigCommand;
...
import co.uk.next.loyalty.admin.application.query.GetAdminDashboardQuery;
import co.uk.next.loyalty.admin.application.query.GetAuditLogsQuery;
import co.uk.next.loyalty.admin.application.query.GetCampaignsQuery;
import co.uk.next.loyalty.admin.application.query.GetRatesConfigQuery;
